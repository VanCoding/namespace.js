(function(){try{fruits.x;}catch(e){fruits={};}try{fruits.x;}catch(e){fruits={};}try{fruits.apples.x;}catch(e){fruits.apples={};}try{fruits.berries.x;}catch(e){fruits.berries={};}try{fruits.apples.x;}catch(e){fruits.apples={};}try{fruits.berries.x;}catch(e){fruits.berries={};}try{fruits.berries.moreberries.x;}catch(e){fruits.berries.moreberries={};}try{fruits.berries.moreberries.x;}catch(e){fruits.berries.moreberries={};}with(fruits)with(fruits.apples)with(fruits.berries)with(fruits.berries.moreberries){fruits.FruitBasket=(function(){
...
function out(){
    ...
    this.type = type;
    this.name = name;
};return out;})();}with(fruits)with(fruits.apples)with(fruits.berries)with(fruits.berries.moreberries){fruits.FruitBasket=(function(){
